...
namespace AdministrarTiendaElect.Migrations
{
    ...
    [Migration("20240523141748_muchosmuchos proveedor producto")]
    partial class muchosmuchosproveedorproducto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductoProveedor", b =>
                {
                    ...
                    b.HasKey("ProductosID_Producto", "ProveedoresID_Proveedor");
            ...
            modelBuilder.Entity("ProductoProveedor", b =>
                {
                    b.HasOne("AdministrarTiendaElect.Data.Producto", null)
                        .WithMany()
                        .HasForeignKey("ProductosID_Producto")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AdministrarTiendaElect.Data.Proveedor", null)
                        .WithMany()
